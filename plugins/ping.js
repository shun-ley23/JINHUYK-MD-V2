...
let ping = await conn.sendMessage(from , { text: '*_JINHUYK-MD-V2 TESTING..._*'  }, { quoted: mek } )
...
const startTime = Date.now()
        ...
        await conn.sendMessage(from, { text: `*❄️JINHUYK-MD'S Speed... : ${ping}ms*`}, { quoted: message })
    } catch (e) {
        console.log(e)
        reply(`${e}`)
    }
